    ...
    <div class="p-4 bg-base-200/50 rounded-box border border-base-200">
      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        <label class="form-control w-full">
          ...
          <input type="text" v-model="localConfig.innerRadius" class="input input-bordered input-sm w-full"
            placeholder="40%" />
        </label>
        ...
        <label class="form-control w-full">
          ...
          <input type="text" v-model="localConfig.outerRadius" class="input input-bordered input-sm w-full"
            placeholder="70%" />
        </label>
      </div>
